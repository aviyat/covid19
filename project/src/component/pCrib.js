...
export default connect(mapStateToProps, mapDispatcToProps)(function PCrib(props) {
  ...
  useEffect(async () => {
    ...
    data.data.map(element => (element.type=="Crib"? setAllProducts(allProducts => [...allProducts, element]):" "))
