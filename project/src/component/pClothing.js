...
export default connect(mapStateToProps, mapDispatcToProps)(function PClothing(props) {
  ...
  useEffect(async () => {
    ...
    data.data.map(element => (element.type=="Clothing"? setAllProducts(allProducts => [...allProducts, element]):" "))
